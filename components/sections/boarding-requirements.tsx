      ...
      <div className="pt-10">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-10 my-10">
          {[
            ...
            <div
              key={index}
              className="w-full max-w-[300px] h-[325px] bg-white shadow-lg rounded-xl overflow-hidden border-gray flex flex-col justify-between transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl"
            >
