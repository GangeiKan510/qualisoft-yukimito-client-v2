...
function InstantBookingForm() {
  ...
  return (
    <div className="w-[500px] h-[500px] shadow-lg rounded-[16px] bg-white">
      <div className="p-8">
        <div className="text-[24px] text-center text-primary-dark font-bold">
        ...
        <div className="my-5 flex flex-col gap-5">
          <div>
            ...
            <select
              name="service"
              id="service"
              className="w-[436px] text-secondary-dark h-[40px] border border-primary-dark text-primary-dark ps-2 rounded-[8px]"
            >
          ...
          <div>
            ...
            <DatePicker
              ...
              className="w-[436px] text-primary-dark h-[40px] border border-primary-dark ps-2 rounded-[8px]"
            />
          </div>
          <div>
            <div className="mb-1 text-primary-dark font-semibold">
